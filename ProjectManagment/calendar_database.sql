...
CREATE TABLE `event_tags` (
  ...
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `event_tags_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `events` (`event_id`) ON DELETE CASCADE,
  CONSTRAINT `event_tags_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`tag_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `events` VALUES (6,1,1,'Software Engineering Midterm Study Session','Reviewing project management chapters and database schemas.','2026-04-10','18:00:00','20:00:00','Library Study Room B','Academic',15,'2026-03-22 12:48:46'),(7,1,1,'InfoSec Club: ARP Spoofing Lab','Join us to practice network traffic analysis and learn how to secure networks.','2026-04-15','18:00:00','20:00:00','Keiser Main Computer Lab','Workshop',30,'2026-04-01 04:33:11');
...
INSERT INTO `tags` VALUES (1,'Sports'),(2,'Religion'),(3,'Tech & Gaming'),(4,'Student Government');
...
CREATE TABLE `user_subscriptions` (
  ...
  CONSTRAINT `user_subscriptions_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`tag_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-31 16:43:51
